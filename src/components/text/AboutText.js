  ...
  return (
    <div className="about-text">
      <h1 className="about-title">
        A passionate <span className="yellow">Mobile Developer</span> specialised on <span className="yellow">Android</span> applications.
      </h1>
      <p>
        I started working as an Android Developer in 2013.
        From that moment until now I have been learning the most used technologies related to<span className="yellow"> Mobile </span>and<span className="yellow"> Web development</span>.
        <br></br>As it is an industry in constant evolution I like to spend my free time working on personal projects to update my knowledge.
      </p>
      <h1 className="about-title">
      ...
      <p>
        ...
        <br></br>
        Also working on my free time on an English-language-learning Android application and collaborating to the <span className="yellow">UrbanNoise</span> open-source project.
      </p>
      {style}
    </div>
  );
